...
const savedListings = [
  {
    id: "1",
    title: "Орчин үеийн 3 өрөөтэй байр",
    price: "450,000,000₮",
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 animate-fade-in-up">
          <h1 className="text-3xl font-bold text-foreground mb-2">Хадгалсан зарууд</h1>
          <p className="text-muted-foreground">Таны хадгалсан үл хөдлөх хөрөнгийн зарууд</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Select value={filterStatus} onValueChange={setFilterStatus}>
                ...
                <SelectContent>
                  <SelectItem value="all">Бүгд</SelectItem>
                  <SelectItem value="Зарах">Зарах</SelectItem>
              ...
              <CardContent className="p-4">
                <div className="space-y-3">
                  ...
                  <div className="text-xs text-muted-foreground">
                    Хадгалсан: {new Date(listing.savedDate).toLocaleDateString("mn-MN")}
                  </div>
        ...
        {filteredListings.length === 0 && (
          <div className="text-center py-12 animate-fade-in-up">
            ...
            <h3 className="text-xl font-semibold mb-2">Хадгалсан зар байхгүй</h3>
            <p className="text-muted-foreground mb-4">Та одоогоор ямар нэг зар хадгалаагүй байна</p>
            <Link href="/rent">
