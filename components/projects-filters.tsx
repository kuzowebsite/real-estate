...
export function ProjectsFilters() {
  const [priceRange, setPriceRange] = useState([80000000, 800000000])
  ...
  const quickFilters = ["Шинэ барилга", "Лифт", "Аюулгүй байдал", "Спорт зал", "Усан сан", "Хүүхдийн тоглоомын талбай"]
      ...
      <div className="container mx-auto px-4">
        <Card className="animate-fade-in-up">
          <CardContent className="p-6">
            {/* Property Types */}
            <div className="mb-6">
              <h3 className="text-lg font-semibold mb-4">Төлөвлөт төрөл</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">Дуусах хугацаа</label>
                <Select>
                  <SelectTrigger>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="2027+">2027+ он</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <div className="mb-6">
              <label className="text-sm font-medium mb-4 block">
                Захиалгын үнэ: {priceRange[0].toLocaleString()}₮ - {priceRange[1].toLocaleString()}₮
              </label>
              <Slider
                value={priceRange}
