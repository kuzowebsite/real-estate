...
export function PropertyFilters() {
  ...
  const quickFilters = ["Шинэ барилга", "Тавилгатай", "Гараж", "Лифт", "Аюулгүй байдал", "Зөөлөн амьтан зөвшөөрөх"]
        ...
        <Card className="animate-fade-in-up">
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">Унтлагын өрөө</label>
                <Select>
                  <SelectTrigger>
                    <SelectValue placeholder="Өрөөний тоо" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="studio">Студи</SelectItem>
            ...
            <div className="mb-6">
              <label className="text-sm font-medium mb-4 block">
                Үнийн хязгаар: {priceRange[0].toLocaleString()}₮ - {priceRange[1].toLocaleString()}₮
              </label>
              <Slider
                value={priceRange}
