...
export function SaleListings() {
  ...
  const saleProperties = [
    ...
    },
    {
      ...
      features: ["Зогсоол", "Аюулгүй байдал", "Лифт"],
      status: "Борлуулалтад",
      agent: "ООО Бизнес Центр",
      phone: "70001234",
    ...
    },
    {
      ...
      features: ["Шинэ засвар", "WiFi", "Аюулгүй байдал"],
      status: "Борлуулалтад",
      agent: "С.Сайхан",
      phone: "88776655",
    ...
    <section className="py-12 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Борлуулалтын зарууд</h2>
            <p className="text-muted-foreground">{saleProperties.length} зар олдлоо</p>
          </div>
              ...
              >
                ...
                <CardContent className={`p-4 ${viewMode === "list" ? "flex-1" : ""}`}>
                  ...
                  <div className="text-sm text-muted-foreground mb-4">
                    <span className="font-medium">Зуучлагч:</span> {property.agent}
                  </div>
