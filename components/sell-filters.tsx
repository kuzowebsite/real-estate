...
export function SellFilters() {
  const [priceRange, setPriceRange] = useState([50000000, 500000000])
  ...
  const quickFilters = ["Шинэ барилга", "Тавилгатай", "Лифт", "Аюулгүй байдал", "Гэрчилгээтэй"]
          ...
          <CardContent className="p-6">
            ...
            <div className="mb-6">
              <label className="text-sm font-medium mb-4 block">
                Худалдах үнэ: {priceRange[0].toLocaleString()}₮ - {priceRange[1].toLocaleString()}₮
              </label>
              <Slider
                value={priceRange}
